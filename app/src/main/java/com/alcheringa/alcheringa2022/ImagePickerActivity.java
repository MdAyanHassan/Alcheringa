...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    private void cropImage(Uri sourceUri) {
        ...
        options.setToolbarColor(ContextCompat.getColor(this, R.color.btnOrange));
        options.setStatusBarColor(ContextCompat.getColor(this, R.color.btnOrange));
