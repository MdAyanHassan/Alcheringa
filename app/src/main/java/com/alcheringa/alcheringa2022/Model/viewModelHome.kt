...
//    }
  ...
  fun getAllEvents(){
    ...
    val featuredevents= listOf(
        ...
        eventdetail("Voice of Alcheringa","Competitions", starttime = OwnTime(12, 12, 0) ,durationInMin = 90, venue = "Auditorium 1" ,imgurl = "",type = "Music", descriptionEvent = "This event is for the lone wolves unafraid to showcase their unique voices.We call out to all the nightingales to soar high on this Alcheringa. May the most melodious master prevail!\n", genre = listOf("Music")),
        eventdetail("Alcher Got Talent","Competitions", starttime = OwnTime(12, 14, 0) ,durationInMin = 60, venue = "Auditorium 1" ,imgurl = "",type = "Class Apart", descriptionEvent = "Every soul has a purpose, an inner voice and an unbeaten talent that has been fueled by passion! So look within, and bring the best version of yourself to life. Go carve your own niche with “Alcher’s got talent”- the talent search competition hosted by Alcheringa!\n", genre = listOf("Music", "Dance", "Fashion", "Drama")),
        eventdetail("Sixth String","Competitions", starttime = OwnTime(12, 13, 0) ,durationInMin = 60, venue = "Auditorium 2" ,imgurl = "", type = "Class Apart",descriptionEvent = "Where words fail, music speaks. Let your guitar speak for you as we showcase your skills on the biggest cultural fest in the whole of North-East India, Alcheringa. \n", genre = listOf("Music")),
        eventdetail("So You think You can Dance","Competitions", starttime = OwnTime(12, 15, 0) ,durationInMin = 90, venue = "Auditorium 1" ,type = "Any Body Can Dance",imgurl = "", descriptionEvent = "This dance event full of high spirit, ultimate competition and enthusiasm, organised under north-east unveiled, this enormous dance event experiences a great amount of participation of talented dancers from all over the north-east. High level of dedication towards dance can be seen In each move of their dance styles.", genre = listOf("Dance")),
        eventdetail("Just Reel it","Competitions", starttime = OwnTime(12, 16, 0) ,durationInMin = 30, venue = "Auditorium 2" ,imgurl = "",type = "Lights Camera Action", descriptionEvent = "Ever wondered…. I could make that reels on instagram! Well, to all the fans of reels out there, here we are to give you an opportunity to show your creativity and skills with Musicaly, an online reels making competition for all the creative peeps to put on their thinking caps and come out with the most creative short video—------------=.\n", genre = listOf("Music", "Dance")),
        eventdetail("Rap Battle","Competitions", starttime = OwnTime(13, 12, 0) ,durationInMin = 60, venue = "Auditorium 1" ,imgurl = "",type = "Class Apart", descriptionEvent = "Think you are a great rapper? Then its time to win hearts with your beats. Some say rapping is the best form of expression! Choice of words , rhythm or shear passion. Here's the biggest online Rapping Competition of 2022 hosted by Alcheringa\n", genre = listOf("Music")),
        eventdetail("Directors' Cut", "Competitions", starttime = OwnTime(13, 13, 0) ,durationInMin = 120, venue = "Auditorium 2" ,imgurl = "",type = "Lights Camera Action", descriptionEvent = "Director’s cut provides the perfect curtain for your film direction skills, your way of portraying ideas through a story, the art of film and short movie making in general. This competition will force you to propel yourself towards the peak of your skills and come out  the best out of the all round competition. \n", genre = listOf("Drama")),
        eventdetail("Literary Module","Competitions", starttime = OwnTime(13, 14, 0) ,durationInMin = 60, venue = "Auditorium 1" ,imgurl = "",type = "Literary", genre = listOf("Literary")),
        eventdetail("Electric Heels","Competitions", starttime = OwnTime(13, 15, 0) ,durationInMin = 90, venue = "Auditorium 1" ,imgurl = "",type = "Any Body Can Dance", descriptionEvent = "Presenting to you Electric heels, the most exhilarating group dance contest where the best Dance squads across the nation dance their way to win one of the flagship events of alcheringa, we believe in uniqueness. So your style, your rhythm, your beats and our arena. let's see what you got!\n", genre = listOf("Dance")),
        eventdetail("Choir","Competitions", starttime = OwnTime(13, 16, 0) ,durationInMin = 60, venue = "Auditorium 2" ,imgurl = "",type = "music", descriptionEvent = "We cannot listen to one voice above all others. We must listen to a choir of voices if we are to understand the individual tunes. We make many sounds from our mouth without knowing what if we combine them in a single melody….here we give you a chance to present your skills through Alcheringa.\n", genre = listOf("Music")),
