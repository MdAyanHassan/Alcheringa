...
//                            }
    ...
    @Composable
    fun Test(eventDetails: SnapshotStateList<merchModel>){
        val textPaintStroke = Paint().asFrameworkPaint().apply {
            isAntiAlias = true
            style = android.graphics.Paint.Style.STROKE
            textSize = 88f
        ...
        if(true) {
            Card(
                ...
                Box(modifier = Modifier
                    .clickable {
                        NavHostFragment
                            .findNavController(this@MerchFragmentCompose)
...
//                    .commit()
                    ...
                    Image(
                        painter = painterResource(id = R.drawable.merch_bg_1),
                        contentDescription = null,
                        Modifier
                            .height(200.dp)
                            .fillMaxWidth()
...
//                                )
                                ...
                                Spacer(modifier = Modifier.height(4.dp))
                                Text(
                                    text = eventDetails[0].material.uppercase(),
                                    color = black,
                                    fontWeight = FontWeight.Normal,
                                    fontSize = 12.sp,
                                    fontFamily = star_guard,
                            ...
                            GlideImage(modifier = Modifier
                                ...
                                .align(Alignment.CenterVertically)
                                .padding(vertical = 10.dp),
                                imageModel = eventDetails[0].image_url,
