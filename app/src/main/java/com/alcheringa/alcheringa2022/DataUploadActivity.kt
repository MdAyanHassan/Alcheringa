    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val newEvents= listOf(
                eventdetail(
                        ...
                        "",
                        type = "Creators' Camp",
                        starttime = OwnTime(12,17,30) ,
                        durationInMin =60,
                        venue = "Auditorium",
                        imgurl = "",
                        descriptionEvent="In our Sports Panel, we have the renowned Indian Extreme Rally Driver, Garima Avtar. She is the First Professional Woman Driver for Mercedes-Benz Luxe Drive since 2016. Register now to join us in an interesting conversation with her career in the intensive racing action.", genre = listOf("music"),
                ),
                eventdetail(
                        "Achievers’ Panel",
                        "",
                        ...
                        venue = "Auditorium",
                        imgurl = "",
                        descriptionEvent="In our Achievers' Panel, joining us as panelists are the well-known entreprenuer, digital creator and co-founder of Career Keeda, Deepak Pareek along with Babar Ali, the World's Youngest Headmaster. Stay tuned for this fascinating session about the journey through their careers!", genre = listOf("music"),
                ),
/*                eventdetail(
                        "UNGA",
